...
namespace ShopoesAPI.Migrations
{
    ...
    [Migration("20241030091254_UpdateColumnInCart")]
    partial class UpdateColumnInCart
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopoesAPI.Models.Cart", b =>
                {
                    ...
                    b.Property<int>("IdProductVarientNavigationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdProductVarientNavigationId");
            ...
            modelBuilder.Entity("ShopoesAPI.Models.Cart", b =>
                {
                    ...
                    b.HasOne("ShopoesAPI.Models.ProductVarient", "IdProductVarientNavigation")
                        .WithMany()
                        .HasForeignKey("IdProductVarientNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
